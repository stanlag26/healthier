...
const defaultImage =
    'https://firebasestorage.googleapis.com/v0/b/doctor-a0382.appspot.com/o/images%2Fpills.jpg?alt=media&token=55627479-0ad8-4454-b7b2-5fe54648578f';

abstract class MyTextStyle {
  static const TextStyle textStyle25Bold =
      TextStyle(fontSize: 25, fontWeight: FontWeight.w600, color: Colors.black);
  static const TextStyle textStyle25BoldWhite =
  ...
  static const TextStyle textStyle10White =
